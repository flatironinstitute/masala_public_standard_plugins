...
/// @file src/optimizers/optimizers_apps/generate_optimizers_api.hh
/// @brief An application used for auto-generating the optimizers API JSON.
...
main(
    ...
    api_definition["Module"] = "Optimizers";
    nlohmann::json api_entries;
    
    std::vector< masala::base::MasalaObjectSP > const api_objects( standard_masala_plugins::optimizers::api::generate_api_classes() );
    ...
    masala::base::managers::disk::MasalaDiskManager::get_instance()->write_ascii_file( "optimizers_api.json", ss.str() );
