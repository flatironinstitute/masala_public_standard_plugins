...
/// @file src/numeric_api/base_classes/optimization/gradient_based/DFPFunctionOptimizer.cc
/// @brief Implementation of the DFPFunctionOptimizer.
/// @details The DFPFunctionOptimizer carries out gradient-descent minimization of an arbitrary function
/// for which gradients are available using the quasi-Newtonian Davidon-Fletcher-Powell
/// algorithm.
...
DFPFunctionOptimizer::clone() const {
	return masala::make_shared< DFPFunctionOptimizer >(*this);
}
...
DFPFunctionOptimizerSP
DFPFunctionOptimizer::deep_clone() const {
	DFPFunctionOptimizerSP new_obj( std::static_pointer_cast< DFPFunctionOptimizer >( clone() ) );
...
/// @returns { { "Optimizer", "RealValuedFunctionLocalOptimizer", "QuasiNewtonianFunctionOptimizer", "DFPFunctionOptimizer" } }
...
DFPFunctionOptimizer::get_categories() const {
	return std::vector< std::vector< std::string > > {
		{ "Optimizer", "RealValuedFunctionLocalOptimizer", "QuasiNewtonianFunctionOptimizer", "DFPFunctionOptimizer" }
	};
}

/// @brief Get the keywords for this plugin class.  Default for all optimizers; may be overridden
/// by derived classes.
/// @returns { "optimizer", "real_valued", "local_optimizer", "gradient_based", "numeric", "quasi_newtonian", "dfp" }
std::vector< std::string >
DFPFunctionOptimizer::get_keywords() const {
...
/// @returns { {"Optimizer", "RealValuedFunctionLocalOptimizer", "QuasiNewtonianFunctionOptimizer", "DFPFunctionOptimizer"} }
std::vector< std::vector < std::string > >
DFPFunctionOptimizer::get_engine_categories() const {
    return std::vector< std::vector < std::string > >{ { "Optimizer", "RealValuedFunctionLocalOptimizer", "QuasiNewtonianFunctionOptimizer", "DFPFunctionOptimizer" } };
}

/// @brief Every class can name itself.
/// @returns "DFPFunctionOptimizer".
std::string
DFPFunctionOptimizer::class_name() const {
...
std::string
DFPFunctionOptimizer::class_namespace() const {
...
/*static*/
std::string
DFPFunctionOptimizer::class_name_static() {
	return "DFPFunctionOptimizer";
}
...
/*static*/
std::string
DFPFunctionOptimizer::class_namespace_static() {
...
DFPFunctionOptimizer::get_api_definition() {
	...
	if( api_definition() == nullptr ) {
		MasalaObjectAPIDefinitionSP api_def(
			masala::make_shared< MasalaObjectAPIDefinition >(
				*this,
				"A gradient-descent function optimizer that uses the Davidon-Fletcher-Powell "
				"algorithm (DFP), a quasi-Newtonian method that relies only on gradients to approximate the inverse "
				"Hessian matrix, to carry out gradient descent for a differentiable function in R^N.",
				false, false
			)
		);
		
		ADD_PUBLIC_CONSTRUCTOR_DEFINITIONS( DFPFunctionOptimizer, api_def );
		...
		api_def->add_setter(
			masala::make_shared< MasalaObjectAPISetterDefinition_OneInput< Size > >(
				...
				false, false, std::bind( &DFPFunctionOptimizer::set_max_iterations, this, std::placeholders::_1 )
			)
		);
		api_def->add_setter(
			masala::make_shared< MasalaObjectAPISetterDefinition_OneInput< Size > >(
				...
				false, false,
				std::bind( &DFPFunctionOptimizer::set_threads_to_request, this, std::placeholders::_1 )
			)
		);
		{
			MasalaObjectAPISetterDefinition_OneInputSP< MasalaEngineAPICSP > set_line_optimizer_setter(
				masala::make_shared< MasalaObjectAPISetterDefinition_OneInput< MasalaEngineAPICSP > >(
					...
					false, false, std::bind( &DFPFunctionOptimizer::set_line_optimizer, this, std::placeholders::_1 )
				)
			);
		...
		api_def->add_setter(
			masala::make_shared< MasalaObjectAPISetterDefinition_OneInput< Real > >(
				...
				false, false,
				std::bind( &DFPFunctionOptimizer::set_tolerance, this, std::placeholders::_1 )
			)
		);
		api_def->add_setter(
			masala::make_shared< MasalaObjectAPISetterDefinition_OneInput< Real > >(
				...
				false, false,
				std::bind( &DFPFunctionOptimizer::set_gradient_tolerance, this, std::placeholders::_1 )
			)
		);
		api_def->add_setter(
			masala::make_shared< MasalaObjectAPISetterDefinition_OneInput< bool > >(
				...
				false, false,
				std::bind( &DFPFunctionOptimizer::set_throw_if_iterations_exceeded, this, std::placeholders::_1 )
			)
		);
		api_def->add_setter(
			masala::make_shared< MasalaObjectAPISetterDefinition_OneInput< Real > >(
				...
				false, false,
				std::bind( &DFPFunctionOptimizer::set_min_inv_hessian_determinant, this, std::placeholders::_1 )
			)
		);
		...
		api_def->add_getter(
			masala::make_shared< MasalaObjectAPIGetterDefinition_ZeroInput< Size > >(
				...
				false, false, std::bind( &DFPFunctionOptimizer::max_iterations, this )
			)
		);
		api_def->add_getter(
			masala::make_shared< MasalaObjectAPIGetterDefinition_ZeroInput< Size > >(
				...
				"may be smaller if there is less work to do, or if there are fewer threads available.",
				false, false,
				std::bind( &DFPFunctionOptimizer::threads_to_request, this )
			)
		);
		api_def->add_getter(
			masala::make_shared< MasalaObjectAPIGetterDefinition_ZeroInput< masala::numeric_api::base_classes::optimization::real_valued_local::PluginLineOptimizerCSP > >(
				...
				false, false, std::bind( &DFPFunctionOptimizer::line_optimizer, this )
			)
		);
		api_def->add_getter(
			masala::make_shared< MasalaObjectAPIGetterDefinition_ZeroInput< Real > >(
				...
				false, false,
				std::bind( &DFPFunctionOptimizer::tolerance, this )
			)
		);
		api_def->add_getter(
			masala::make_shared< MasalaObjectAPIGetterDefinition_ZeroInput< Real > >(
				...
				false, false,
				std::bind( &DFPFunctionOptimizer::gradient_tolerance, this )
			)
		);
		api_def->add_getter(
			masala::make_shared< MasalaObjectAPIGetterDefinition_ZeroInput< bool > >(
				...
				false, false,
				std::bind( &DFPFunctionOptimizer::throw_if_iterations_exceeded, this )
			)
		);
		api_def->add_getter(
			masala::make_shared< MasalaObjectAPIGetterDefinition_ZeroInput< Real > >(
				...
				"which we reset the inverse Hessian to the identity matrix.",
				false, false,
				std::bind( &DFPFunctionOptimizer::min_inv_hessian_determinant, this )
			)
		);
		...
		api_def->add_work_function(
			masala::make_shared< MasalaObjectAPIWorkFunctionDefinition_OneInput< std::vector< RealValuedFunctionLocalOptimizationSolutions_APICSP >, RealValuedFunctionLocalOptimizationProblems_API const & > >(
				"run_real_valued_local_optimizer", "Run the DFP optimizer on a set of loss function "
				...
				std::bind( &DFPFunctionOptimizer::run_real_valued_local_optimizer, this, std::placeholders::_1 )
			)
		);
		api_def->add_work_function(
			masala::make_shared< MasalaObjectAPIWorkFunctionDefinition_OneInput< std::vector< OptimizationSolutions_APICSP >, OptimizationProblems_API const & > >(
				"run_optimizer", "Run the DFP optimizer on a set of loss function local minimization problems, "
				...
				"of solutions corresponds to the problem with the same index.  The various solutions in the "
				"set come from different starting points defined in the problem.",
				std::bind( &DFPFunctionOptimizer::run_optimizer, this, std::placeholders::_1 )
			)
		);
...
void
DFPFunctionOptimizer::protected_assign(
	masala::numeric_api::base_classes::optimization::real_valued_local::PluginRealValuedFunctionLocalOptimizer const & src
) {
	DFPFunctionOptimizer const * src_ptr_cast( dynamic_cast< DFPFunctionOptimizer const * >( &src ) );
...
/// @details Performs no mutex locking.
void
DFPFunctionOptimizer::protected_make_independent() {
	// TODO
