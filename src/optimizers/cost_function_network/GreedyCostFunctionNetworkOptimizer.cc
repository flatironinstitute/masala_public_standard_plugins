...
/*static*/
std::string
GreedyCostFunctionNetworkOptimizer::solution_storage_mode_strings(
    std::string const & delimiter,
    bool const include_and
) {
    using masala::base::Size;
    std::ostringstream ss;
    for( Size i(1); i<=static_cast<Size>(GreedyCostFunctionNetworkOptimizerSolutionStorageMode::NUM_SOLUTION_STORAGE_MODES); ++i ) {
        if( i > 1 ) {
            ss << delimiter;
        }
        if( include_and && static_cast<Size>(GreedyCostFunctionNetworkOptimizerSolutionStorageMode::NUM_SOLUTION_STORAGE_MODES) > 2 ) {
            ss << "and ";
        }
        ss << solution_storage_mode_string_from_enum( static_cast<GreedyCostFunctionNetworkOptimizerSolutionStorageMode>(i) );
    }
    return ss.str();
}
...
GreedyCostFunctionNetworkOptimizer::solution_storage_mode_string_from_enum(
    GreedyCostFunctionNetworkOptimizerSolutionStorageMode const mode_enum
) {
    switch(mode_enum) {
        case GreedyCostFunctionNetworkOptimizerSolutionStorageMode::CHECK_AT_EVERY_STEP :
            return "check_at_every_step";
        case GreedyCostFunctionNetworkOptimizerSolutionStorageMode::CHECK_ON_ACCEPTANCE :
...
/*static*/
GreedyCostFunctionNetworkOptimizerSolutionStorageMode
GreedyCostFunctionNetworkOptimizer::solution_storage_mode_enum_from_string(
    std::string const & mode_string
) {
    using masala::base::Size;
    for( Size i(1); i<=static_cast<Size>(GreedyCostFunctionNetworkOptimizerSolutionStorageMode::NUM_SOLUTION_STORAGE_MODES); ++i ) {
        if( solution_storage_mode_string_from_enum(static_cast<GreedyCostFunctionNetworkOptimizerSolutionStorageMode>(i)) == mode_string ) {
            return static_cast<GreedyCostFunctionNetworkOptimizerSolutionStorageMode>(i);
        }
    }
    return GreedyCostFunctionNetworkOptimizerSolutionStorageMode::INVALID_MODE;
}
    ...
    if( api_description_ == nullptr ) {
		...
		api_description->add_setter(
			masala::make_shared< MasalaObjectAPISetterDefinition_OneInput< Size > > (
				...
				std::bind( &GreedyCostFunctionNetworkOptimizer::set_attempts_per_problem, this, std::placeholders::_1 )
			)
		);
		api_description->add_setter(
			masala::make_shared< MasalaObjectAPISetterDefinition_OneInput< Size > > (
				...
				std::bind( &GreedyCostFunctionNetworkOptimizer::set_n_solutions_to_store_per_problem, this, std::placeholders::_1 )
			)
		);
		api_description->add_setter(
			masala::make_shared< MasalaObjectAPISetterDefinition_OneInput< AnnealingScheduleBase_API const & > > (
				...
				std::bind( &GreedyCostFunctionNetworkOptimizer::set_annealing_schedule, this, std::placeholders::_1 )
			)
		);
        ...
        api_description->add_setter(
            masala::make_shared< MasalaObjectAPISetterDefinition_OneInput< std::string const & > >(
                ...
                false, false, std::bind( &GreedyCostFunctionNetworkOptimizer::set_annealing_schedule_by_name, this, std::placeholders::_1 )
            )
        );
		api_description->add_setter(
			masala::make_shared< MasalaObjectAPISetterDefinition_OneInput< Size > > (
				...
				std::bind( &GreedyCostFunctionNetworkOptimizer::set_annealing_steps_per_attempt, this, std::placeholders::_1 )
			)
		);
		api_description->add_setter(
			masala::make_shared< MasalaObjectAPISetterDefinition_OneInput< std::string const & > > (
                ...
                false, false,
				std::bind(
                    static_cast< void(GreedyCostFunctionNetworkOptimizer::*)(std::string const &) >(
                        &GreedyCostFunctionNetworkOptimizer::set_solution_storage_mode
        ...
        api_description->add_setter(
            masala::make_shared< MasalaObjectAPISetterDefinition_OneInput < bool > >(
                ...
                false, false, std::bind( &GreedyCostFunctionNetworkOptimizer::set_use_multimutation, this, std::placeholders::_1 )
            )
        );
        api_description->add_setter(
            masala::make_shared< MasalaObjectAPISetterDefinition_OneInput < masala::base::Real > >(
                ...
                false, false, std::bind( &GreedyCostFunctionNetworkOptimizer::set_multimutation_probability_of_one_mutation, this, std::placeholders::_1 )
            )
        );
		...
		api_description->add_getter(
			masala::make_shared< MasalaObjectAPIGetterDefinition_ZeroInput< Size > > (
				...
				std::bind( &GreedyCostFunctionNetworkOptimizer::attempts_per_problem, this )
			)
		);
		api_description->add_getter(
			masala::make_shared< MasalaObjectAPIGetterDefinition_ZeroInput< Size > > (
				...
				std::bind( &GreedyCostFunctionNetworkOptimizer::n_solutions_to_store_per_problem, this )
			)
		);
		api_description->add_getter(
			masala::make_shared< MasalaObjectAPIGetterDefinition_ZeroInput< Size > > (
				...
				std::bind( &GreedyCostFunctionNetworkOptimizer::annealing_steps_per_attempt, this )
			)
		);
        api_description->add_getter(
            masala::make_shared< MasalaObjectAPIGetterDefinition_ZeroInput< masala::numeric_api::auto_generated_api::optimization::annealing::AnnealingScheduleBase_API const & > > (
                ...
                std::bind( &GreedyCostFunctionNetworkOptimizer::annealing_schedule, this )
            )
        );
        api_description->add_getter(
            masala::make_shared< MasalaObjectAPIGetterDefinition_ZeroInput< std::string > >(
                ...
                false, false,
                std::bind( &GreedyCostFunctionNetworkOptimizer::solution_storage_mode_string, this )
            )
        );
        api_description->add_getter(
            masala::make_shared< MasalaObjectAPIGetterDefinition_ZeroInput< bool > >(
                ...
                false, false,
                std::bind( &GreedyCostFunctionNetworkOptimizer::use_multimutation, this )
            )
        );
        api_description->add_getter(
            masala::make_shared< MasalaObjectAPIGetterDefinition_ZeroInput< masala::base::Real > >(
                ...
                false, false,
                std::bind( &GreedyCostFunctionNetworkOptimizer::multimutation_probability_of_one_mutation, this )
            )
        );
        ...
        api_description->add_work_function(
            masala::make_shared< MasalaObjectAPIWorkFunctionDefinition_ZeroInput< masala::numeric_api::auto_generated_api::optimization::annealing::AnnealingScheduleBase_API & > > (
                ...
                std::bind( &GreedyCostFunctionNetworkOptimizer::annealing_schedule_nonconst, this )
            )
        );
        api_description->add_work_function(
            masala::make_shared<
...
void
GreedyCostFunctionNetworkOptimizer::set_attempts_per_problem(
...
void
GreedyCostFunctionNetworkOptimizer::set_n_solutions_to_store_per_problem(
...
void
GreedyCostFunctionNetworkOptimizer::set_annealing_schedule(
...
void
GreedyCostFunctionNetworkOptimizer::set_annealing_schedule_by_name(
...
void
GreedyCostFunctionNetworkOptimizer::set_annealing_steps_per_attempt(
...
void
GreedyCostFunctionNetworkOptimizer::set_solution_storage_mode(
    GreedyCostFunctionNetworkOptimizerSolutionStorageMode const solution_storage_mode_in
) {
    CHECK_OR_THROW_FOR_CLASS(
        solution_storage_mode_in != GreedyCostFunctionNetworkOptimizerSolutionStorageMode::INVALID_MODE,
...
GreedyCostFunctionNetworkOptimizer::set_solution_storage_mode(
    ...
    CHECK_OR_THROW_FOR_CLASS(
        mode_enum != GreedyCostFunctionNetworkOptimizerSolutionStorageMode::INVALID_MODE,
...
void
GreedyCostFunctionNetworkOptimizer::set_use_multimutation(
    bool const setting
) {
    std::lock_guard< std::mutex > lock( optimizer_mutex_ );
...
void
GreedyCostFunctionNetworkOptimizer::set_multimutation_probability_of_one_mutation(
...
/// @details Minimum is 1.
masala::base::Size
GreedyCostFunctionNetworkOptimizer::attempts_per_problem() const {
    std::lock_guard< std::mutex > lock( optimizer_mutex_ );
...
masala::base::Size
GreedyCostFunctionNetworkOptimizer::n_solutions_to_store_per_problem() const {
    std::lock_guard< std::mutex > lock( optimizer_mutex_ );
...
masala::base::Size
GreedyCostFunctionNetworkOptimizer::annealing_steps_per_attempt() const {
    std::lock_guard< std::mutex > lock( optimizer_mutex_ );
...
GreedyCostFunctionNetworkOptimizer::annealing_schedule() const {
...
GreedyCostFunctionNetworkOptimizerSolutionStorageMode
GreedyCostFunctionNetworkOptimizer::solution_storage_mode_enum() const {
    std::lock_guard< std::mutex > lock( optimizer_mutex_ );
...
std::string
GreedyCostFunctionNetworkOptimizer::solution_storage_mode_string() const {
    std::lock_guard< std::mutex > lock( optimizer_mutex_ );
...
/// @note We actually take a Poisson distribution and add 1, since we don't want 0 mutations.
bool
GreedyCostFunctionNetworkOptimizer::use_multimutation() const {
    std::lock_guard< std::mutex > lock( optimizer_mutex_ );
...
masala::base::Real
GreedyCostFunctionNetworkOptimizer::multimutation_probability_of_one_mutation() const {
    std::lock_guard< std::mutex > lock( optimizer_mutex_ );
...
GreedyCostFunctionNetworkOptimizer::annealing_schedule_nonconst() {
    CHECK_OR_THROW_FOR_CLASS( annealing_schedule_ != nullptr, "annealing_schedule", "The annealing schedule must be set before it can be accessed." );
    std::lock_guard< std::mutex > lock( optimizer_mutex_ );
    return *annealing_schedule_;
}
    ...
    for( Size i(0); i<nproblems; ++i ) {
        ...
        for( Size j(0); j<attempts_per_problem_; ++j ) {
            work_request.add_job(
                std::bind( &GreedyCostFunctionNetworkOptimizer::run_mc_trajectory, this,
                    j, // replicate index
                    i, // problem index
                    ...
                    ( n_solutions_to_store_per_problem_ > 1 ? solution_storage_mode_ : GreedyCostFunctionNetworkOptimizerSolutionStorageMode::CHECK_ON_ACCEPTANCE ), // The solution storage mode
...
void
GreedyCostFunctionNetworkOptimizer::run_mc_trajectory(
    ...
    GreedyCostFunctionNetworkOptimizerSolutionStorageMode const solution_storage_mode,
    ...
    for( Size step_index(0); step_index < annealing_steps; ++step_index ) {
        ...
        if( solution_storage_mode == GreedyCostFunctionNetworkOptimizerSolutionStorageMode::CHECK_AT_EVERY_STEP ) {
            determine_whether_to_store_solution(
        ...
        if( randgen->apply_metropolis_criterion( deltaE, annealing_schedule_copy->temperature() ) ) {
            ...
            if( solution_storage_mode == GreedyCostFunctionNetworkOptimizerSolutionStorageMode::CHECK_ON_ACCEPTANCE ) {
                determine_whether_to_store_solution(
                    current_solution, candidate_absolute_score, local_solutions, n_solutions_to_store, false
                );
            }
...
/*static*/
void
GreedyCostFunctionNetworkOptimizer::make_mc_move(
...
/*static*/
void
GreedyCostFunctionNetworkOptimizer::make_mc_multimove(
    std::vector< masala::base::Size > & current_solution,
    std::vector< std::pair< masala::base::Size, masala::base::Size > > const & n_choices_per_variable_node,
...
/*static*/
void
GreedyCostFunctionNetworkOptimizer::determine_whether_to_store_solution(
