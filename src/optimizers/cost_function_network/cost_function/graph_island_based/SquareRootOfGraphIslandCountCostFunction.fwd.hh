...
namespace graph_island_based {
	...
	using SquareRootOfGraphIslandCountCostFunctionSP = MASALA_SHARED_POINTER< SquareRootOfGraphIslandCountCostFunction >;

	/// @brief We will use the convention that an class name followed by CSP
	/// represents a MASALA_SHARED_POINTER for const objects of that class.
	using SquareRootOfGraphIslandCountCostFunctionCSP = MASALA_SHARED_POINTER< SquareRootOfGraphIslandCountCostFunction const >;

	/// @brief We will use the convention that an class name followed by WP
	/// represents a MASALA_WEAK_POINTER for objects of that class.
	using SquareRootOfGraphIslandCountCostFunctionWP = MASALA_WEAK_POINTER< SquareRootOfGraphIslandCountCostFunction >;
