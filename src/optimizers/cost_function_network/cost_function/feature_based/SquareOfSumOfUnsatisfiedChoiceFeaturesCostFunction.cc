...
bool
SquareOfSumOfUnsatisfiedChoiceFeaturesCostFunction::protected_empty() const {
	return SumOfUnsatisfiedChoiceFeaturesCostFunction::protected_empty();
}
...
void
SquareOfSumOfUnsatisfiedChoiceFeaturesCostFunction::protected_clear() {
	SumOfUnsatisfiedChoiceFeaturesCostFunction::protected_clear();
}
...
void
SquareOfSumOfUnsatisfiedChoiceFeaturesCostFunction::protected_reset() {
	SumOfUnsatisfiedChoiceFeaturesCostFunction::protected_reset();
}
...
void
SquareOfSumOfUnsatisfiedChoiceFeaturesCostFunction::protected_make_independent() {
...
void
SquareOfSumOfUnsatisfiedChoiceFeaturesCostFunction::protected_assign(
	...
	CHECK_OR_THROW_FOR_CLASS( src_cast_ptr != nullptr, "assign_mutex_locked", "Cannot assign a SquareOfSumOfUnsatisfiedChoiceFeaturesCostFunction "
