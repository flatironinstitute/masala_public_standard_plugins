...
/// @file src/scoring/scoring_apps/generate_scoring_api.hh
/// @brief An application used for auto-generating the scoring API JSON.
...
main(
    ...
    std::vector< masala::base::MasalaObjectSP > const api_objects( standard_masala_plugins::scoring::api::generate_api_classes() );
    ...
    masala::base::managers::disk::MasalaDiskManager::get_instance()->write_ascii_file( "scoring_api.json", ss.str() );
