...
/// @file src/file_interpreters/file_interpreters_apps/generate_file_interpreters_api.hh
/// @brief An application used for auto-generating the file_interpreters API JSON.
...
main(
    ...
    api_definition["Module"] = "FileInterpreters";
    nlohmann::json api_entries;
    
    std::vector< masala::base::MasalaObjectSP > const api_objects( standard_masala_plugins::file_interpreters::api::generate_api_classes() );
    ...
    masala::base::managers::disk::MasalaDiskManager::get_instance()->write_ascii_file( "file_interpreters_api.json", ss.str() );
