...
/// @file tests/unit/optimizers/annealing/LinearAnnealingScheduleTests.cc
/// @brief Unit tests for the LinearAnnealingSchedule class.
...
std::string const test_name( "standard_masala_plugins::tests::unit::optimizers::annealing::LinearAnnealingScheduleTests" );

TEST_CASE( "Instantiate the linear annealing schedule.", "[masala::numeric_api::auto_generated_api::optimization::annealing::LinearAnnealingSchedule_API][optimization]" ) {
    ...
    tracer->write_to_tracer( test_name, "Starting \"Instantiate the linear annealing schedule.\"" );
    ...
    REQUIRE_NOTHROW([&](){
        ...
        LinearAnnealingSchedule_APISP anneal_sched( std::dynamic_pointer_cast< LinearAnnealingSchedule_API >( plugin_object ) );
...
TEST_CASE( "Test the samples of the linear annealing schedule.", "[masala::numeric_api::auto_generated_api::optimization::annealing::LinearAnnealingSchedule_API][optimization]" ) {
    using namespace standard_masala_plugins::optimizers_api::auto_generated_api::annealing;
    using namespace masala::base::managers::tracer;
    using namespace masala::base::managers::plugin_module;
    ...
    REQUIRE_NOTHROW([&](){
		...
		CHECK( expected_vals == actual_vals );
		...
		CHECK( expected_vals == actual_vals2 );
